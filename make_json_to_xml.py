...
img_path = '/home/crescom01/PycharmProjects/handbone_key_point/BA_test_pic' + '/'
train_save_path = 'deep-high-resolution-net.pytorch/data/handbone/images/train' + '/'
val_save_path = 'deep-high-resolution-net.pytorch/data/handbone/images/test' + '/'
xml_path = '/home/crescom01/PycharmProjects/handbone_key_point/test_image_xml' + '/'
...
def coco_keypoint():
    ...
    with open(save_path + 'handbone_test.json','w') as val_json_file:
        json.dump(val_y_dict, val_json_file)
    with open(save_path + 'file_name_test.csv','w', encoding='utf-8',newline='') as f:
        wr = csv.writer(f)
